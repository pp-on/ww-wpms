...
├── README.md                       # German overview (default)
├── README.en.md                    # This file (full English reference)
├── completions/
...
Developed at **[Pfennigparade webwerk](https://www.pfennigparade.de/webwerk)** — Pfennigparade's Medienservice builds accessible websites and digital content, with people with physical disabilities in design, programming and editorial roles.
